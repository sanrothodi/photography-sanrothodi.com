    ...
    return(
        <div className="navbar">
            ...
            <div className="navbar-menu">
                <a href="https://photography.sanrothodi.com/portrait" className="menu-items item-1">Portrait</a>
                <a href="https://photography.sanrothodi.com/product" className="menu-items item-2">Product</a>
                <a href="https://photography.sanrothodi.com/wedding" className="menu-items item-3">Wedding</a>
                <a href="https://photography.sanrothodi.com/contact" className="menu-items item-4">Contact</a>
                <a href="https://photography.sanrothodi.com/about" className="menu-items item-5">About</a>
            </div>
            <div className="navbar-social-media">
                <ul>
                <label className="social-menu twitter-circle">
                ...
                <label className="social-menu linkedin-circle">
                ...
                <label className="social-menu facebook-circle">
                ...
                <label className="social-menu px500-circle">
                ...
                <label className="social-menu instagram-circle">
